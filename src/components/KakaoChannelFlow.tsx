...
import { ChevronLeft, X, MoreVertical, Search, Menu, Home, MessageCircle, Phone } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-[#111]">
        ...
        <div className="px-4 pt-2 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-[52px] h-[52px] bg-[#0050a0] rounded-full flex items-center justify-center shrink-0">
              <span className="text-white text-[10px] font-bold leading-tight text-center">삼성생명</span>
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-1">
                <span className="text-black font-bold text-[16px]">삼성생명</span>
                <div className="w-[16px] h-[16px] bg-[#3DB5F5] rounded-full flex items-center justify-center">
                  <span className="text-white text-[8px] font-bold">✓</span>
                </div>
              </div>
              <p className="text-gray-500 text-[12px]">친구 1,451,268</p>
            </div>
          ...
          <p className="text-gray-600 text-[13px] mt-3">고객과 함께하는 인생금융파트너</p>
      ...
      <div className="flex-1 bg-[#111] overflow-y-auto">
        <div className="px-4 pt-4 pb-2 flex items-center justify-between">
          <h3 className="text-white font-bold text-[16px]">소식</h3>
          ...
          {[
            ...
            <div key={i} className="bg-[#1c1c1c] rounded-lg overflow-hidden">
              <div className="w-full aspect-square bg-gradient-to-br from-[#f5e6d0] to-[#e8d5b8] flex items-center justify-center p-3">
                <span className="text-[10px] text-[#6b5a3e] font-medium text-center leading-tight">{i % 2 === 1 ? '총 2천명 모집!' : '📊'}</span>
              </div>
              <div className="p-2">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl z-20 p-5">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-[36px] h-[36px] bg-[#0050a0] rounded-full flex items-center justify-center shrink-0">
            <span className="text-white text-[7px] font-bold leading-tight text-center">삼성생명</span>
          </div>
          <div className="flex items-center gap-1">
            <span className="text-black font-bold text-[15px]">삼성생명</span>
      ...
      <div className="bg-[#9bbbd4]">
        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="text-center">
            <p className="text-black font-bold text-[14px]">삼성생명 ✦</p>
        ...
        <div className="flex justify-center py-1">
          <span className="bg-black/10 text-black/60 text-[10px] px-3 py-1 rounded-full">✅ 사업자/기관 정보가 확인된 채널</span>
        </div>
        <div className="flex justify-center py-2">
          <span className="bg-white/60 text-black/70 text-[11px] px-3 py-1 rounded-full">2026년 3월 31일 화요일 &gt;</span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-4">
        <div className="flex gap-2 mt-2">
          <div className="w-[32px] h-[32px] bg-[#0050a0] rounded-full flex items-center justify-center shrink-0 mt-1">
            <span className="text-white text-[6px] font-bold leading-tight text-center">삼성생명</span>
          </div>
          <div>
            <span className="text-black/70 text-[11px] font-medium">삼성생명</span>
            ...
            <span className="text-black/40 text-[10px] ml-1">오전 12:56</span>
          </div>
        </div>
      </div>
